  ...
  $("main").append(`
    <div class="grid grid-cols-1 gap-2 p-2">
     <div class="flex justify-between border-2 border-red-500 rounded-full">
      <a href="mailto:admin@integer.fun" class="icon rounded-full bg-red-500 hover:bg-red-600 cursor-pointer">
     ...
     <div class="flex justify-between border-2 border-black rounded-full">
      <a href="https://www.tiktok.com/@sovlow" class="icon rounded-full bg-black hover:bg-red-500 cursor-pointer">
     ...
     <div class="flex justify-between border-2 border-blue-500 rounded-full">
      <a href="https://bit.ly/rizkia_linkedIn" class="icon rounded-full bg-blue-500 hover:bg-blue-600 cursor-pointer">
     ...
     <div class="flex justify-between border-2 border-green-500 rounded-full">
      <a href="https://wa.me/+6282211274577" class="icon rounded-full bg-green-500 hover:bg-green-600 cursor-pointer">
     ...
     <div class="flex justify-between border-2 border-gray-500 rounded-full">
      <a href="https://github.com/sovlow" class="icon rounded-full bg-gray-500 hover:bg-black cursor-pointer">
     ...
     <div class="flex justify-between border-2 border-blue-500 rounded-full">
      <a href="https://discord.com/channels/@sovlow" class="icon rounded-full bg-blue-500 hover:bg-blue-600 cursor-pointer">
